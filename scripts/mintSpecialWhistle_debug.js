...
async function main() {
  const contractAddress = "0xEf78796Ad8a3B18f83D1804bc7C2143fE5B8d07c"; // your deployed BaseDeckNFT
  ...
  if (whistleCount >= max) return console.warn("❌ Max supply reached");
  if (now - lastMint < 14 * 24 * 60 * 60) return console.warn("❌ Cooldown active");
